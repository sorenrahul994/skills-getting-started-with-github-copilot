document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // helper to escape HTML for participant names
      ...
      Object.entries(activities).forEach(([name, details]) => {
          ...
          const items = details.participants
            .map((p) => `
              <li>
                ...
                <button class="remove-btn" data-email="${escapeHtml(p)}" aria-label="Remove ${escapeHtml(p)}">✕</button>
              </li>`)
            .join('');
        ...
        // animate card in
        requestAnimationFrame(() => activityCard.classList.add('show'));
